...
This is the core release-decision workspace flow: create experiment, update decision state, configure metrics, create/update runs, and read detail/list output.

```mermaid
flowchart TD
    A["HTTP request<br/>ReleaseDecision<br/>ExperimentController.cs"]
    B["Input DTOs / commands<br/>CreateReleaseDecision<br/>Experiment.cs<br/>UpdateReleaseDecision<br/>Experiment.cs<br/>UpdateReleaseDecision<br/>Metrics.cs<br/>ManageReleaseDecision<br/>ExperimentRun.cs"]
    ...
    G["Persisted models<br/>ReleaseDecision<br/>Experiment.cs<br/>ReleaseDecision<br/>ExperimentRun.cs<br/>ReleaseDecision<br/>Activity.cs"]
    H["EF mappings<br/>ReleaseDecision<br/>ExperimentConfiguration.cs<br/>ReleaseDecision<br/>ExperimentRunConfiguration.cs<br/>ReleaseDecision<br/>ActivityConfiguration.cs<br/>AppDbContext.cs"]
...
| `ReleaseDecisionExperimentVm.cs` | output and query input | List/detail VMs, run/activity VMs, plus list filter/query request classes. |
