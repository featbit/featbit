...
Navigate to **modules/back-end/src/Api** folder and run `dotnet run`, then the Scalar UI should be available
at [http://localhost:5000/scalar](http://localhost:5000/scalar).
