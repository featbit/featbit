...
3. Migrate the shell: login, auth guard, secure-area layout, side menu, header, account menu with current version display, theme switcher, locale switcher, and workspace/org/project/env switching. See [implementation detail 03](implementation-details/03-shell-and-navigation.md).
...
- Component tests: login, header switchers, account menu version display, theme switcher, menu permission visibility, and core drawer/modal/form/table behavior in both light and dark mode where visual state matters.
