...
export const enReleaseHealth = {
  ...
  binding: {
    ...
    previewNotice:
      "Design preview with sample metrics. Changes last until you leave this page; no alerts are sent.",
    pausedHelp: "Monitoring is paused. Saving this binding keeps it paused.",
    savedPreview: "Binding saved in this design preview.",
    removedPreview: "Binding removed from this design preview.",
    duplicate:
...
export const zhReleaseHealth: typeof enReleaseHealth = {
  ...
  binding: {
    ...
    previewNotice:
      "当前为示例指标的设计预览。修改仅保留到离开本页，不会发送告警。",
    pausedHelp: "监控已暂停，保存绑定不会恢复监控。",
    savedPreview: "绑定已保存到当前设计预览。",
    removedPreview: "绑定已从当前设计预览移除。",
