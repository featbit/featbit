...
export const enReleaseHealth = {
  ...
  monitor: {
    ...
    metricsDescription:
      "Select connected project metrics to observe trends or check against a rule.",
    observation: "Observation",
    ...
    advancedTitle: "Rule check settings",
    advancedSummary:
      "{{warmup}} warm-up · {{lookback}} lookback · {{guards}} Guards",
    showAdvanced: "Advanced settings",
    hideAdvanced: "Hide advanced",
    windowTitle: "Evaluation window",
    windowDescription:
      "New configuration applies to subsequent rule checks. Historical checks and alerts retain the configuration used at the time.",
    warmup: "Warm-up",
    lookback: "Lookback",
    evaluation: "Evaluate every",
    sustain: "Sustain",

    title: "Configure health monitor",
    description:
      "Configure ongoing monitoring for this feature flag and environment.",
    monitoringStatus: "Monitoring status",
    automaticHelp:
      "Enabled bindings are checked automatically, and flag changes appear on the timeline. Saving configuration keeps paused monitoring paused.",
    save: "Save monitor",
  },
  flag: {
...
export const zhReleaseHealth: typeof enReleaseHealth = {
  ...
  monitor: {
    ...
    trendOnly: "仅观察趋势",
    advancedTitle: "规则检查设置",
    advancedSummary:
      "{{warmup}} 预热 · {{lookback}} 回看 · {{guards}} 个 Guard",
    showAdvanced: "高级设置",
    hideAdvanced: "收起高级设置",
    windowTitle: "评价窗口",
    windowDescription:
      "新配置生效后用于后续规则检查；历史检查与告警保留当时的配置。",
    warmup: "Warm-up",
    lookback: "Lookback",
    evaluation: "评价间隔",
    sustain: "异常持续",

    title: "配置 Health Monitor",
    description: "为当前功能开关和环境配置持续监控。",
    monitoringStatus: "监控状态",
    automaticHelp:
      "启用的绑定按配置自动检查，Flag 变更自动进入时间轴。保存配置不会恢复已暂停的监控。",
    save: "保存 Monitor",
  },
  flag: {
