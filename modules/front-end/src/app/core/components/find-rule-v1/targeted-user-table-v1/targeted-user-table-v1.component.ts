...
@Component({
  selector: 'targeted-user-table-v1',
  templateUrl: './targeted-user-table-v1.component.html',
  styleUrls: ['./targeted-user-table-v1.component.less']
})
export class TargetedUserTableV1Component implements OnInit {
