...
import { variationReferences, variationValueError } from "./variations-utils"
...
export function VariationsTab({
  ...
  const { startPreview, movePreview, removePreview } = useVariationDragPreview()
                    ...
                    <div className="pr-4">
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          className={`size-2.5 shrink-0 rounded-full ring-1 ring-background ${variationMarkerColor(index)}`}
                        />
                        <Input
                      ...
                      {nameError ? (
                        <p className="mt-1 text-xs text-destructive">
                          {t(
                            "featureFlags.detailsPage.variations.nameRequired"
                          )}
                        </p>
                      ) : null}
                    </div>
                    <div className="pr-4">
                      {flag.variationType === "json" ? (
                        ...
                        <Input
                          ...
                          disabled={
                            !editable || flag.variationType === "boolean"
                          }
