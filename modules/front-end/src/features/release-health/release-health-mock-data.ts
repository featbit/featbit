...
export const releaseMetrics: ReleaseMetric[] = [
  ...
  },
  {
    ...
    observationScope: "environment",
    source: "OpenTelemetry",
    sourceEvent: "http.server.duration",
    aggregation: "p95",
    unit: "ms",
    version: 5,
    usedByMonitors: 6,
  ...
  },
  {
    ...
    source: "FeatBit events",
    sourceEvent: "checkout_completed",
    aggregation: "unique converters / exposed users",
    unit: "%",
    version: 2,
    usedByMonitors: 2,
  ...
  },
  {
    ...
    observationScope: "environment",
    source: "OpenTelemetry",
    sourceEvent: "process.runtime.dotnet.gc.heap.size",
    aggregation: "max",
    unit: "%",
    version: 1,
    usedByMonitors: 4,
  ...
  },
  {
    ...
    observationScope: "environment",
    source: "FeatBit events",
    sourceEvent: "app_crash",
    aggregation: "1 - crashed / sessions",
    unit: "%",
    version: 1,
    usedByMonitors: 1,
