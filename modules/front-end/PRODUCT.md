...
Success means the React app feels like a capable feature-management workbench: clear context, low-noise density, visible risk and status, reliable light and dark themes, and reusable shadcn/Tailwind-based components that keep page development consistent and efficient.
...
Use a neutral palette, shared spacing tokens, and standard shadcn/Base UI controls. Avoid green-dominant product surfaces.

The React login experience should follow the saved design contracts in `design/login-page-design.md` and `design/sso-login-page-design.md`.
...
5. Keep product behavior and presentation consistent. Preserve information architecture and backend contracts while using the shared React design system.
