...
- When migrating layout behavior into `front-end-v2`, treat the old implementation as a behavioral reference, not a component or styling source. Recreate the layout in `front-end-v2` with the current shadcn/ui + Base UI setup and default shadcn styles wherever possible.
