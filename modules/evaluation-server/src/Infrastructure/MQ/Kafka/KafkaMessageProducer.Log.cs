...
public partial class KafkaMessageProducer
{
    public static partial class Log
    {
        ...
        private static partial void ErrorDeliveryMessageCore(ILogger logger, string topic, string value, Error error);
        ...
        /// </summary>
        public static void ErrorDeliveryMessage(ILogger logger, string topic, string value, Error error)
