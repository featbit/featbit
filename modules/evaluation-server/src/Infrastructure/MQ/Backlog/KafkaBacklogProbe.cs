...
/// number of messages produced that this group has not yet acknowledged. For this service it is the
/// most direct available answer to "are flag changes reaching SDK clients?", because everything
/// downstream of the consume loop is in-process fan-out.
/// </para>
/// <para>
