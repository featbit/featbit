          ...
          billing: {
            ...
            drawer: {
              ...
              features: {
                ...
                globalUsersShareableSegments: "Global users & Shareable segments",
            ...
            dialog: {
              ...
              upgradeSubtitle: "Review what unlocks now and what your recurring total will look like.",
              downgradeSubtitle: "See what stays active until renewal and what changes on your next cycle.",
              ...
              upgradeActionDescription: "Your workspace will move to the new plan immediately after confirmation. Any proration is calculated separately at checkout.",
              downgradeActionDescription: "Your current access remains in place until renewal, then the new recurring total takes over on the next cycle.",
              billedMonthly: "Billed monthly",
              billedAnnually: "Billed annually",
              paymentPreview: "Payment preview",
              orderSummary: "Order summary",
              orderSummaryDescription: "Review the recurring amount and any immediate billing impact before you confirm.",
              ...
              noPaymentTodayDescription: "Your current charges stay in place until the next billing cycle begins.",
              upgradeNoteLimitsTitle: "New limits and features unlock right away",
              upgradeNoteLimitsDescription: "Your team can start using the upgraded plan as soon as the change is confirmed.",
              upgradeNoteProrationTitle: "You only pay the difference for the rest of this cycle",
              upgradeNoteProrationDescription: "We calculate any immediate prorated charge separately from the recurring amount shown here.",
              upgradeNoteRecurringTitle: "Your new recurring total starts with the new cycle",
              upgradeNoteRecurringDescription: "Future invoices will follow the billing cadence selected for this plan.",
              downgradeNoteTimingTitle: "Nothing changes until the current cycle ends",
              downgradeNoteTimingDescription: "Your current workspace access and paid features remain active until renewal.",
              downgradeNotePriceTitle: "The new price starts on the next invoice",
              downgradeNotePriceDescription: "The recurring total in the summary becomes active when the next billing cycle begins.",
              downgradeNoteReviewTitle: "You can still review usage before the switch",
              downgradeNoteReviewDescription: "The selected MAU and add-ons are captured so the lower tier matches what you expect at renewal.",
        ...
        workspace: {
          ...
          billing: {
            ...
            dialog: {
              ...
              downgradeSubtitle: "查看续订前保留的内容，以及下个周期会发生的变化。",
              ...
              upgradeActionDescription: "确认后，当前工作区会立即切换到新套餐。任何按比例费用会在结账时单独计算。",
              downgradeActionDescription: "当前权限会保留到续订日，新的周期费用将在下个账单周期生效。",
              billedMonthly: "按月计费",
              billedAnnually: "按年计费",
              paymentPreview: "付款预览",
              orderSummary: "订单摘要",
              orderSummaryDescription: "确认前请检查周期费用以及可能产生的即时账单影响。",
              ...
              upgradeNoteLimitsDescription: "变更确认后，团队可以立即使用升级后的套餐能力。",
              upgradeNoteProrationTitle: "本周期只需支付差额",
              upgradeNoteProrationDescription: "即时按比例费用会与这里显示的周期费用分开计算。",
              upgradeNoteRecurringTitle: "新的周期费用从新周期开始",
              upgradeNoteRecurringDescription: "未来账单会按照该套餐选择的计费周期生成。",
              downgradeNoteTimingTitle: "当前周期结束前不会变化",
              downgradeNoteTimingDescription: "当前工作区权限和付费功能会保留到续订日。",
              downgradeNotePriceTitle: "新价格从下一张账单开始",
              downgradeNotePriceDescription: "摘要中的周期费用会在下个账单周期开始时生效。",
              downgradeNoteReviewTitle: "切换前仍可检查用量",
              downgradeNoteReviewDescription: "已选择的 MAU 和附加功能会被保存，以便续订时切换到预期配置。",
