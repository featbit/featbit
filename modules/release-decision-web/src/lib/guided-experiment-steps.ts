...
export const GUIDED_EXPERIMENT_STEPS: GuidedExperimentStep[] = [
  ...
  },
  {
    ...
    agentPromptTemplate: [
      ...
      "",
      "Act as a release-decision workflow agent. Help the user define one deciding metric, a small set of guardrails, the event instrumentation, the run window, and the run traffic sampling plan.",
