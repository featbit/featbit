...
All runtime experiment reads, writes, MCP token operations, and analysis requests go through the FeatBit API. Do not add Next.js API routes, server actions, frontend Prisma access, or browser-visible signing keys in this package.
