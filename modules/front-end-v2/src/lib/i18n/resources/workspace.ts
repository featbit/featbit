export const enWorkspace = {
  ...
  license: {
    ...
    licenseKeyHelper: "Paste your license key.",
    licenseKeyOptions: "Request a free trial or contact the FeatBit team.",
    ...
    noLicenseDescription:
      "No license is installed. Enterprise features remain unavailable until a license is added.",
...
export const zhWorkspace = {
  ...
  license: {
    ...
    copied: "已复制",
    licenseKey: "许可证 Key",
    licenseKeyHelper: "粘贴许可证 Key。",
    licenseKeyOptions: "申请免费试用或联系 FeatBit 团队。",
  ...
  billing: {
    ...
    drawer: {
      ...
      features: {
        ...
        globalUsersShareableSegments: "全局用户和可共享用户组",
        autoAgents: "FeatBit Auto agents",
      },
    },
    dialog: {
