...
public sealed class SegmentCommittedPendingPostgresTests : IntegrationTestBase, IAsyncLifetime
{
    private readonly PostgresFixture _fixture;

    public SegmentCommittedPendingPostgresTests(PostgresFixture fixture)
    {
        _fixture = fixture;
    }

    private readonly string _dbName = "segmentcommittedpendingp_{Guid.NewGuid():N}";
