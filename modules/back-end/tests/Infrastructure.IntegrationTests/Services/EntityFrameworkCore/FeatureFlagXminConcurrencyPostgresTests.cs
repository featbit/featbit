...
public sealed class FeatureFlagXminConcurrencyPostgresTests : IntegrationTestBase, IAsyncLifetime
{
    private readonly PostgresFixture _fixture;

    public FeatureFlagXminConcurrencyPostgresTests(PostgresFixture fixture)
    {
        _fixture = fixture;
    }

    private readonly string _dbName = "featureflagxminconcurren_{Guid.NewGuid():N}";
