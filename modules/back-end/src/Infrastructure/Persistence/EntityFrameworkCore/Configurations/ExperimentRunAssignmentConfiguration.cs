...
public class ExperimentRunAssignmentConfiguration : IEntityTypeConfiguration<ExperimentRunAssignment>
{
    public void Configure(EntityTypeBuilder<ExperimentRunAssignment> builder)
    {
        builder.ToTable("experiment_run_assignments");
