...
public class ExperimentMetricEventConfiguration : IEntityTypeConfiguration<ExperimentMetricEvent>
{
    public void Configure(EntityTypeBuilder<ExperimentMetricEvent> builder)
    {
        ...
        builder.Property(x => x.ApplicationType).HasColumnName("application_type").HasMaxLength(64);
