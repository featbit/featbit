...
public class ExperimentExposureEventConfiguration : IEntityTypeConfiguration<ExperimentExposureEvent>
{
    public void Configure(EntityTypeBuilder<ExperimentExposureEvent> builder)
    {
