...
public partial class RedisMessageProducer
{
    ...
    {
        [LoggerMessage(1, LogLevel.Debug, "Message {Message} was published successfully.", EventName = "MessagePublished")]
        public static partial void MessagePublished(ILogger<RedisMessageProducer> logger, string message);

        [LoggerMessage(2, LogLevel.Error, "Exception occured when publish message.", EventName = "ErrorPublishMessage")]
