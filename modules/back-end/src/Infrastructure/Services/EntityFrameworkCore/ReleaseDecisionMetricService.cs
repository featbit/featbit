...
public class ReleaseDecisionMetricService(AppDbContext dbContext) : IReleaseDecisionMetricService
{
        ...
        ReleaseDecisionMetricFilter filter)
    {
        ...
        var query = dbContext.Set<ReleaseDecisionMetric>()
            .AsNoTracking()
        ...
        ReleaseDecisionMetricUpdate update)
    {
        ...
        await dbContext.Set<ReleaseDecisionMetric>().AddAsync(metric);
        ...
        string key)
    {
        ...
        var metric = await dbContext.Set<ReleaseDecisionMetric>()
            .AsNoTracking()
    ...
    private async Task<ReleaseDecisionMetric> GetTrackedMetricAsync(Guid envId, Guid id)
    {
        var metric = await dbContext.Set<ReleaseDecisionMetric>()
            .AsTracking()
