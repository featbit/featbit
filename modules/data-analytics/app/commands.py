...
from app.postgresql.commands import migrate as migrate_postgre
...
@click.option("--print-sql",
              ...
              help="Use with --plan or --check. Also prints SQL for each migration to be applied.")
@with_appcontext
def migrate_postgresql(upto, check, plan, print_sql):
    migrate_postgre(upto, check, plan, print_sql)
