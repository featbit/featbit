...
| 6 | Register and select primary/guardrail metrics | `GET/POST/PUT /api/v1/envs/{envId}/release-decision/metrics`, `PUT /api/v1/envs/{envId}/release-decision/experiments/{id}/metrics` |
