...
dependencies {
    ...
    // FeatBit native server-side Java SDK (used directly from Kotlin, NOT via OpenFeature).
    implementation("co.featbit:featbit-java-sdk:${featbitVersion}")
