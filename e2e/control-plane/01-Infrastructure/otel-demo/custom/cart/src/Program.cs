...
// cart flags fall back to safe defaults and the service runs as before.
FeatBitFlags.Init(app.Services.GetRequiredService<ILogger<FeatBitFlags>>());
app.Lifetime.ApplicationStopping.Register(FeatBitFlags.Shutdown);
