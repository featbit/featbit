...
$imageDefs = [ordered]@{
    "api-server" = @{
        ...
        # The Dockerfile COPYs from both back-end/ and shared/, so the build
        # context must be the modules/ directory.
    ...
    "evaluation-server" = @{
        ...
        # The Dockerfile COPYs from both evaluation-server/ and shared/, so the
